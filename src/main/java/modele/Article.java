...
public class Article {
	...
	public void setQuantitéEnStock(int quantitéEnStock) throws PanierException {
		if (this.quantitéEnStock<0) {
			throw new PanierException("Il n'y a plus d'articles en stock");
		}
